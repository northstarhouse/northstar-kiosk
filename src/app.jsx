              ...
              <div className="space-y-3 md:space-y-6">
                ...
                <div className="grid grid-cols-3 gap-2 md:gap-4">
                  <button
                    ...
                    className="bg-white hover:bg-stone-100 active:bg-stone-200 text-stone-800 p-3 md:p-6 rounded-full border-2 border-stone-300 text-sm md:text-xl font-semibold shadow-sm hover:shadow-md transition-all flex flex-col items-center gap-1 md:gap-2"
                  >
