const { useState, useEffect } = React;
    ...
    const NorthStarKiosk = () => {
      ...
      const dutyAreas = {
        ...
        landscape: ['Mike Frasu', 'Nadine Kapper', 'Deanna Bloom', 'Bob Parker', 'Mark Hermes', 'Debbie Stackhouse', 'Bob Aha'],
            ...
            <div className="max-w-2xl mx-auto w-full">
              ...
              <div className="space-y-3 md:space-y-6">
                ...
                >
                  ...
                  <span className="flex-1 text-left">Available Side Jobs</span>
                </button>
